...
export default function UncontrolledForm(){
   ...
   const [{values, reset, onSubmit},{input}] = useForm({initialValues})
   const codeBlock = `
      import {useForm} from 'react-data-forms'
      ...
      function ControlledForm(){
         ...
         const [{values, reset},{input}] = useForm({initialValues})
         return (
            <form onSubmit={onSubmit((e)=>{console.log(e)})}>
      ...
      <div class="row">
         ...
         <div class="col-md-6 p-4">
            <div style={{borderRadius:3, border:"1px solid #333", height:'100%', padding:10}}>
                  <h2 className="text-align-center">Uncontrolled Forms</h2>
            </div>
         </div>
         <div class="col-md-6 m-t-50 p-4">
            <form style={{border:"1px solid #333", borderRadius:3, padding:10}} onSubmit={onSubmit((e)=>{console.log(e)})}>
